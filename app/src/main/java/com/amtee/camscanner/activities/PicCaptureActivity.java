...
import com.amtee.camscanner.utilities.camera_utils.CameraPreview;
 ...
 */
public class PicCaptureActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initPalletes();
        customProgressDialog = new CustomProgressDialog(PicCaptureActivity.this, R.mipmap.progress_img);
    }
    ...
    private void alertCameraServiceFailed(String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(PicCaptureActivity.this, android.R.style.Theme_DeviceDefault_Light_Dialog));
    ...
    public static void setCameraDisplayOrientation(Activity activity,
        ...
        int result = PicCaptureActivity.getCameraDisplayOrientation(activity,
                cameraId, camera);
